...
class KMeans:
    def __init__(self, n_clusters=8, max_iter=1000, p = 1):
    ...
    def fit(self, X_train):
        ...
        for _ in range(self.n_clusters-1):
            ...
            dists = np.sum([DistanceMatrices.minkowski(X_train, centroid, self.p) for centroid in self.centroids], axis=0)
        ...
        while np.not_equal(self.centroids, prev_centroids).any() and iteration < self.max_iter:
            ...
            for x in X_train:
                dists = DistanceMatrices.minkowski(x, self.centroids, self.p)
